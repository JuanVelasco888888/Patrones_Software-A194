"""
simulation/data_simulator.py

Generador de datos FUNCIONAL (sin sensores ni hardware/IoT real). Se
inspira en el enfoque de simulación del repositorio de referencia
(AI-Enabled-Smart-Grid-Monitoring-System / data_generation.py): una
curva de demanda día/noche construida con funciones matemáticas, para
poder probar todo el sistema sin depender de una fuente externa.
"""
import math
import random
